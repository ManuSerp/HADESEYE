...
children = [
    dict(name='sigopts', title='Signal Options', type='group', children=[
        ...
        dict(name='nsamples', type='int', limits=[
             0, None], value=args.nsamples),
        dict(name='frames', type='int', limits=[1, None], value=args.frames),
        dict(name='fsample', title='sample rate',
             type='float', value=args.fsample, units='Hz'),
    ...
    dict(name='enableExperimental', type='bool',
         value=pg.getConfigOption('enableExperimental')),
    dict(name='pen', type='pen', value=default_pen),
    dict(name='antialias', type='bool', value=pg.getConfigOption('antialias')),
    dict(name='connect', type='list', limits=[
         'all', 'pairs', 'finite', 'array'], value='all'),
    dict(name='fill', type='bool', value=False),
    dict(name='skipFiniteCheck', type='bool', value=False),
    dict(name='plotMethod', title='Plot Method',
         type='list', limits=['pyqtgraph', 'drawPolyline'])
]

params = ptree.Parameter.create(
    name='Parameters', type='group', children=children)
...
params.child('enableExperimental').sigValueChanged.connect(
    onEnableExperimentalChanged)
